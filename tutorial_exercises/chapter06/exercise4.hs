    ...
    then throwError $ BadSpecialForm "No true clause in cond expression: " form
           ...
           List [test, expr]        -> do
               ...
               case result of
                 ...
                 Bool True  -> eval expr
                 otherwise  -> throwError $ TypeMismatch "boolean" test
           _ -> throwError $ BadSpecialForm "Syntax error in cond expression: " form
...
stringAppend args         = mapM unpackStr args >>= return . String . foldl1 (++)
